...
- Fixed to back to top directive to hide the component if the `buttonHidden` option is enabled after the component is rendered. [#219](https://github.com/blackbaud/skyux-layout/pull/219)
