...
/**
 * Specifies the maximum number of text characters to display inline when
 * users click the link to expand the full text. If the text exceeds this
 * limit, then the component expands the full text in a modal instead.
 * @default 600
 */
  @Input()
...
/**
 * Specifies the maximum number of newline characters to display inline when
 * users click the link to expand the full text. If the text exceeds this
 * limit, then the component expands the full text in a modal view instead.
 * @default 2
 */
  @Input()
...
/**
 * Specifies the number of text characters to display before truncating the
 * text. To avoid truncating text in the middle of a word, the component looks
 * for a space in the 10 characters before the last character.
 * @default 200
 */
  @Input()
